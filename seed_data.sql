...
-- for the id columns, the database would choo_se an integer for us.

INSERT INTO addresses (id, line_1, city, _state, zipcode) VALUES (1, '6232 Guiseppe Courts', 'Jamartown', 'Maryland', '49028');
INSERT INTO addresses (id, line_1, city, _state, zipcode) VALUES (2, '704 Cecil Mountain', 'West Jon', 'South Dakota', '91578');
INSERT INTO addresses (id, line_1, city, _state, zipcode) VALUES (3, '41613 Huel Ranch', 'Loycefort', 'Florida', '12109');
INSERT INTO addresses (id, line_1, city, _state, zipcode) VALUES (4, '1397 Braden Shoals', 'New Karine', 'New York', '03913');
...
INSERT INTO classes (id, _name, credits) VALUES (1, 'CS 101', 4);
INSERT INTO classes (id, _name, credits) VALUES (2, 'HIST 107', 3);
INSERT INTO classes (id, _name, credits) VALUES (3, 'SPAN 210', 3);
INSERT INTO classes (id, _name, credits) VALUES (4, 'PHYS 218', 4);
INSERT INTO classes (id, _name, credits) VALUES (5, 'ART 118', 2);
